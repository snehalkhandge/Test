namespace Myware.Data.Entity.Migrations
{
    ...
    public partial class UserManagment : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.RoleRolePermissions",
                c => new
                    {
                        Role_Id = c.Int(nullable: false),
                        RolePermissions_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.Role_Id, t.RolePermissions_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RoleRolePermissions", "RolePermissions_Id", "dbo.RolePermissions");
            DropForeignKey("dbo.RoleRolePermissions", "Role_Id", "dbo.AspNetRoles");
            ...
            DropIndex("dbo.RoleRolePermissions", new[] { "RolePermissions_Id" });
            DropIndex("dbo.RoleRolePermissions", new[] { "Role_Id" });
            ...
            DropTable("dbo.RoleRolePermissions");
